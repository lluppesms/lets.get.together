...
export default defineConfig({
  ...
  use: {
    ...
    baseURL: 'https://letsgettogether.luppes.com',
    //baseURL: 'https://localhost:44349/',
    //baseURL: 'http://lll-gettogether-web-demo.azurewebsites.net/',

    // baseURL: process.env.CI ? 
    //   process.env.TEST_ENVIRONMENT == 'PROD' ? 'http://lll-gettogether.azurewebsites.net' :
    //   process.env.TEST_ENVIRONMENT == 'DEMO' ? 'http://lll-gettogether-web-demo.azurewebsites.net' :
    //   process.env.TEST_ENVIRONMENT == 'DEV' ? 'http://lll-gettogether-web-dev.azurewebsites.net' :
    //   process.env.TEST_ENVIRONMENT == 'QA' ? 'http://lll-gettogether-web-qa.azurewebsites.net' :
    //   'http://lll-gettogether-web-demo.azurewebsites.net' : 'https://localhost:44349/',
