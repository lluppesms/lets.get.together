...
param googleClientId = '#{GOOGLE_CLIENT_ID}#'
param googleClientSecret = '#{GOOGLE_CLIENT_SECRET}#'
param facebookAppId = '#{FACEBOOK_APP_ID}#'
param sendGridFromEmail = '#{SENDGRID_FROM_EMAIL}#'
param sendGridFromName = '#{SENDGRID_FROM_NAME}#'
